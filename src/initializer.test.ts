...
async function expectBasicScaffold(projectDir: string): Promise<void> {
...
describe('Template initializer (Story 001.0) [REQ-INIT-DIRECTORY]', () => {
...
describe('Template initializer (Story 001.0) [REQ-INIT-FASTIFY-HELLO]', () => {
...
describe('Template initializer (Story 001.0) [REQ-INIT-DIRECTORY validation]', () => {
...
describe('Template initializer (Story 001.0) [REQ-INIT-GIT-CLEAN]', () => {
  it('initializes git repo, returns matching projectDir, and scaffolds project files when git is available', async () => {
    ...
    await expectBasicScaffold(projectDir);
