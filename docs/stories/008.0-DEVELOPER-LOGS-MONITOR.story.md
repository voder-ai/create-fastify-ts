...
- [x] **Structured Logs Visible**: Running `npm run dev` shows structured JSON logs in human-readable format (via pino-pretty)
...
- [x] **Log Level Configuration**: Documentation shows how to change log level via environment variable
