...
- [ ] **Server Starts Without Pre-Built Dist**: Running `npm run dev` immediately after `npm install` (without running `npm run build` first) successfully compiles TypeScript and starts the server
