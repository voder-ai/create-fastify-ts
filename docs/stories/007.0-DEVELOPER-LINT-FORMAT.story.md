...
- [ ] **Lint Check Passes**: Running `npm run lint` completes successfully with no errors on fresh template code
- [ ] **Format Check Passes**: Running `npm run format:check` completes successfully with no formatting issues on fresh template code
- [ ] **Lint Auto-Fix Works**: Running `npm run lint:fix` automatically corrects fixable linting issues
- [ ] **Format Auto-Fix Works**: Running `npm run format` automatically formats all files to match Prettier style
...
- [ ] `npm run lint` executes successfully with no errors on fresh template code
- [ ] `npm run format:check` executes successfully with no formatting issues
- [ ] `npm run lint:fix` automatically corrects fixable linting issues
- [ ] `npm run format` automatically formats code consistently
